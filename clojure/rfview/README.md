...
* [`src/cljs/rfview/`](src/cljs/rfview/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/rfview/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `rfview` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/rfview/config.cljs) defaults to `true` in
...
```clj
(ns rfview.example
  (:require [rfview.config :as config])
